	...
	function rtt_update_activity_after_thumb_set( $id ) {
		...
		if ( ! empty( $activity_id ) ) {
			...
			$wpdb->update(
				...
				array( // phpcs:ignore WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.DirectDatabaseQuery.DirectQuery.
				'type'    => 'rtmedia_update',
...
function rtt_get_transcoding_status( $post_id ) {
	...
	require_once RT_TRANSCODER_PATH . 'admin/class-rt-transcoder-handler.php'; // phpcs:ignore WordPressVIPMinimum.Files.IncludingFile.UsingCustomConstant.
